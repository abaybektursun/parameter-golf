...
class Hyperparameters:
    ...
    qk_gain_init = float(os.environ.get("QK_GAIN_INIT", 1.70000))
...
class Muon(torch.optim.Optimizer):
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            # Single-rank fast path: avoid flatten/unflatten staging buffers.
            if world_size == 1:
                for p in params:
                    if p.grad is None:
                        continue
...
def main() -> None:
    ...
    # Keep linear weights in bf16 to avoid per-forward fp32->bf16 cast overhead.
